    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
        ...
        <div class="row mx-3">
            ...
            <!-- DAFTAR LAPORAN ===============================-->
            <a href="daftar_laporan.php?page=daftar_laporan" class="card col-12 col-sm-6 col-md-3 border-1 mt-2 sm-1 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
            ...
            <!-- DAFTAR LAPORAN ===============================-->
              ...
              <a href="" class="card col-12 col-sm-6 col-md-3 border mt-2 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
                      <span class="info-box-icon elevation-1 shadow-lg">
              ...
              <a href="laporan.php?page=laporan" class="card col-12 col-sm-6 col-md-3 border mt-2 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
            ...
            <!-- /.col -->
              ...
              <a href="layanan.php?page=layanan" class="card col-12 col-sm-6 col-md-3 border mt-2 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
            ...
            <!-- /.col -->
              ...
              <a href="laporan_bbl.php?page=laporan_bbl" class="card col-12 col-sm-6 col-md-3 border mt-2 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
            ...
            <!-- /.col -->
              <a href="laporan_tambahan.php?page=laporan_tambahan" class="card col-12 col-sm-6 col-md-3 border mt-2 text-dark shadow">
                  <div class="info-box mb-3 mt-2 bg-light rounded">
