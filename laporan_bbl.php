...
<div class="container" style="position: relative; top: 100px;">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h3 class="text-center">BNBA LAPORAN BBL</h3>
        </div>
                ...
                <table class="table table-bordered border table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalhapusbbl<?= $no ?>">Hapus</a>
                        </td>
                    </tr>
...
<!-- Button trigger modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel"><b>EDIT LAPORAN BBL</b></h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action="bbl_crud.php" method="POST" style="position: relative; top:-150px;">
                                            <div class="container">
                                                <div class="card p-2" style="position: relative; top:-200px;">
                                                    ...
                                                    <div class="rounded p-2">
                                                        <div class="input-field form-group">
                                                            <input type="text" required name="keterangan3" value="<?= $data['keterangan3'] ?>">
                                                            <label>KETERANGAN</label>
                                                        </div><br>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                        <button type="submit" name="ubahbbl" class="btn btn-primary">Ubah</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <!-- Button trigger modal -->
                            <!-- Modal hapus-->
                            <div class="modal fade" id="modalhapusbbl<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="hapusbbl" class="btn btn-primary">Ya</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel"><b>TAMBAH DATA BBL</b></h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <form action="bbl_crud.php" method="POST" style="position: relative; top:-10px;">
                            <div class="modal-form">
                                <div class="input-field form-group">
                                    <input type="date" required name="tanggal" id="tanggal" placeholder="dd/mm/yy" pattern="\d{2}/\d{2}/\d{2}" 
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" name="simpanbbl" class="btn btn-primary">Simpan</button>
                                </div>
                            </div>
