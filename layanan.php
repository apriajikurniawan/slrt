...
<div class="container" style="position: relative; top: 100px;">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h3 class="text-center">BNBA PELAYANAN DI SEKRETARIAT SLRT</h3>
        </div>
...
<!-- Button trigger modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel"><b>EDIT LAPORAN PELAYANAN</b></h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action="layanan_crud.php" method="POST" style="position: relative; top:-150px;">
                                            <div class="container">
                                                <div class="card p-2" style="position: relative; top:-200px;">
                                                    ...
                                                    <div class="rounded p-2">
                                                        <div class="input-field form-group">
                                                            <input type="text" required name="keterangan2" value="<?= $data['keterangan2'] ?>">
                ...
                <div class="modal fade" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel"><b>TAMBAH DATA PELAYANAN</b></h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <form action="layanan_crud.php" method="POST" style="position: relative; top:-10px;">
                            <div class="modal-form">
                                ...
                                <div class="input-field form-group">
                                    <input type="text" required name="keterangan2">
                                    <label>KETERANGAN</label>
                                </div><br>
